...
export function generateResumeHTML(staticData, translations, currentLang) {
      ...
      return `
            <div class="item-box job">
                <div style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap; margin-bottom: 4px;">
                    <strong style="margin-right: 15px;"><span class="material-symbols-outlined" style="font-size: 1.1em; vertical-align: sub;">work</span> ${titleHtml}</strong>
  ...
  const summaryText =
    s.basics[currentLang === "es" ? "summary_es" : "summary_en"] || "";
