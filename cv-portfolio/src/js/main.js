...
function setupEventListeners() {
    ...
    if (btnEs) btnEs.addEventListener("click", () => {
        printSingleLanguage("es", staticData, currentLang, loadResumeData, renderResume);
    });

    const btnEn = document.getElementById("print-en");
    if (btnEn) btnEn.addEventListener("click", () => {
        printSingleLanguage("en", staticData, currentLang, loadResumeData, renderResume);
    });
